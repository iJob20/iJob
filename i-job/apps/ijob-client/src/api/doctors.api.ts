      ...
      res([
        {
          ...
          imgUrl:
            import.meta.env.REACT_APP_ASSETS_BUCKET +
            '/doctors/cameron-bell.webp',
        ...
        },
        {
          ...
          rating: 5,
          imgUrl:
            import.meta.env.REACT_APP_ASSETS_BUCKET + '/doctors/steve.webp',
          phone: '+X-XXX-XXX-XXXX',
